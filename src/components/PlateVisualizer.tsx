  ...
  return (
    <div className="border border-[#1a1a1a] bg-black p-4">
      <div className="mb-3 flex items-center justify-between">
        <span className="text-[9px] font-mono uppercase tracking-widest text-neutral-500">Bar load</span>
        <span className="text-[10px] font-mono font-bold text-neutral-300">{weight} {units}</span>
      </div>
      <div className="flex h-20 items-center justify-center">
        ...
        <div className="flex h-20 items-center gap-0.5">
          {plates.length === 0 && <span className="px-3 text-[9px] font-mono uppercase text-neutral-600">Bar only</span>}
