...
export function BackupPanel() {
  ...
  return (
    <div className="flex items-center justify-between gap-4 border border-[#1a1a1a] bg-[#0c0c0c] p-4 -mt-[17px] border-t-0">
      <div>
        <span className="block text-xs font-bold uppercase tracking-tight">Backup</span>
        <span className="font-mono text-[10px] text-neutral-500">Export or restore local data</span>
